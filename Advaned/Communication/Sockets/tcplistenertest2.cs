...
using ServiceStart = System.Action<System.Net.Sockets.TcpListener>; // we use this metod in this case
...
static class Test
{
	...
	public static void Main()
	{
		...
		ServiceStart ss = Service;
		for(int i = 0; i < 3; i++)
			ss.BeginInvoke(listener, null, null);
